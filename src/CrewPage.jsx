...
export default function CrewPage() {
 ...
 const buildSystem = () => {
    ...
    return [
     ...
     "  - VEGETARIAN = zero meat, fish, seafood. Also zero animal-derived products used in production: parmesan contains animal rennet (not vegetarian), anchovies are fish (not vegetarian), worcestershire sauce contains anchovies. Always check hidden animal ingredients.",
