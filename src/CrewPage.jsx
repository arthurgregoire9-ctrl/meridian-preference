...
export default function CrewPage() {
 ...
 const buildSystem = () => {
    ...
    return [
      ...
      "Before proposing ANY dish, mentally scan EVERY ingredient against EVERY guest's allergies, dislikes AND diet. If ANY ingredient conflicts with ANY guest, the dish is invalid.",
      "",
      "═══════════════════════════════════════",
